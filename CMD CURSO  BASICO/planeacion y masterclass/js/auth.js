...
function updateUserUI(user) {
    // Buscar el header o un contenedor seguro donde poner el botón
    const container = document.querySelector('header') || document.querySelector('.container') || document.body;
