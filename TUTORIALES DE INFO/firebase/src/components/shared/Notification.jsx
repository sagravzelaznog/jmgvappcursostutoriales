...
const Notification = ({ message, type = 'info', onClose, autoClose = true, autoCloseDuration = 5000 }) => {
  ...
  const getNotificationStyles = () => {
    const baseStyles = 'relative p-4 pr-10 mb-4 rounded-lg shadow-md transition-all duration-200 transform';
    const typeStyles = {
